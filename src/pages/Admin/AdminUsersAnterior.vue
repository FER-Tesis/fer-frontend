<template>
  <div class="admin-users">
    ...
    <section class="panel">
      ...
      <!-- TAB 3: Métricas Generales -->
      <div v-else>
        <h3 class="panel-title sr-only">Métricas Generales</h3>
          ...
          <section class="metrics-card">
            <header class="metrics-header">
              <div>
                ...
                <p>Emociones registradas esta semana</p>
              </div>
            </header>

            <div class="metrics-body emotions-body">
              ...
              <ul class="emotion-legend">
                ...
                >
                  ...
                  <span class="emotion-pct">{{ item.percent }}%</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section class="metrics-card">
            <header class="metrics-header">
              <div>
                ...
                <p>Evolución de emociones por día de la semana</p>
              </div>
            </header>
            ...
            <div class="metrics-body">
              <div class="week-bars">
                ...
                >
                  <div class="week-bar">
                    <div
                      class="seg seg-stress"
                      :style="{ height: day.stressed + '%' }"
                    ></div>
                    <div
                      class="seg seg-neutral"
                      :style="{ height: day.neutral + '%' }"
                    ></div>
                    <div
                      class="seg seg-positive"
              ...
              <div class="week-legend">
                <span class="legend-item">
                  <span class="swatch swatch-positive"></span> Positivo / Relajado
                </span>
                <span class="legend-item">
                  <span class="swatch swatch-neutral"></span> Neutral
                </span>
                <span class="legend-item">
                  <span class="swatch swatch-stress"></span> Tenso / Estresado
                </span>
              </div>
            </div>
          </section>
